...
#pragma region 오버로딩
	...
	// message.Send("Identify the issue frequency sihnal : ", 60);

	// 함수의 오버로딩은 경우 함수의 매개 변수에 전달하는 인수의
...
#pragma region 가상 함수
	...
	while (true)
	{
		cout << "1. POWER" << "2. AGILITY" << "3. INTELLIGENCE" << endl;
		cout << "Choice : ";
		cin >> choice;

		switch (choice) {
		case 1: pointer = new Power;
			break;
		case 2: pointer = new Agility;
			break;
